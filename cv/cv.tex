...
Software engineer at ease across the stack and at home in cross-functional teams. Keen on robust APIs, DevOps practices and ensuring all disciplines have a seat at the table. I believe in automation to achieve consistency and enable teams to focus on delivery and problem-solving.
\end{adjustwidth}

%----------- SKILLS-----------
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Python, SQL (Postgres), Bash, Java, TypeScript} \\
     \textbf{Frameworks}{: FastAPI, Pydantic, SQLAlchemy, Alembic, Django, React, Angular, pytest, Selenium} \\
     \textbf{Tools}{: Git, Docker, GitLab pipelines, Terraform, Google Cloud, make, pre-commit} \\
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      Research on paraphrasing verbal metonymy via computational methods supported by Amazon through an AWS Educate grant.
      Awarded the 2017 Q-Step Prize for best quantitative dissertation. \href{https://arxiv.org/abs/1709.06162}arxiv.org/abs/1709.06162
      \end{adjustwidth}
  \resumeSubHeadingListEnd
...
%      \textit{Issued MMM YYYY - expires MMM YYYY} \\
%     }}
%  \end{itemize}
