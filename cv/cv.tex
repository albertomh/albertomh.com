...
%----------- SKILLS-----------
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Frameworks}{: FastAPI, Pydantic, Django, Spring, React, Angular, pytest, Selenium} \\
     \textbf{Tools}{: Git, Docker, GitLab pipelines, Terraform, Google Cloud Platform, make, pre-commit} \\
